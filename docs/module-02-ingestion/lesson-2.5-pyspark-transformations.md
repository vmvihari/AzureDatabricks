...
def test_transformations(spark):
    # 1. Arrange: Mock data with hyphens, unapproved statuses, and multiple states
    mock_data = [
        Row(loan_id=1, applicant_ssn="123-45", loan_amount=100.0, state="TX", status="APPROVED"),
        Row(loan_id=2, applicant_ssn="999-99", loan_amount=200.0, state="TX", status="DENIED"),
        Row(loan_id=3, applicant_ssn="111-11", loan_amount=300.0, state="TX", status="APPROVED")
    ]
