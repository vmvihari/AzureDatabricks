...
In this module, you will learn PySpark fundamentals and explore all major ingestion methodologies: reading from File Systems (CSV/JSON/Parquet), Database Tables (JDBC), and REST APIs (HTTP). You will also set up the Continuous Integration pipeline that protects every lesson's code going forward.
...
- [Lesson 2.6: Continuous Integration — The 3-Gate Quality Model](lesson-2.6-github-actions-ci.md)
